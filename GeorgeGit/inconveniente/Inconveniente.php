...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="inconveniente.css"/>
...
<!--HEADER-->
    ...
    <div class="content-base">
        ...
        <div class="navbar">
            <a href="/">Acasa</a> <!--TODO-->
            <a href="anunturi">Anunturi</a> <!--TODO-->
            <div class="dropdown">
                <button class="dropbtn">Meniu</button>
                <div class="dropdown-content">
                    <a href="routes.html">Calatorii</a> <!--TODO-->
...
<div class="container">
    ...
    <form method="get">
        ...
        <div class="row">
            <button class ="sendButton" type="button" onclick="alert('succesfully added!'); sendPostData()" id="send">Send</button>
        </div>
    </form>
</div>
        </div>
...
<script>
    ...
    function sendPostData () {
        ...
        let params= `nume=${nume}&&&prenume=${prenume}&&&mail=${mail}&&&country=${country}&&&complain=${complain}`;
        console.log(nume);
        console.log( prenume );
        console.log( mail );
        console.log( complain );
        let toSend = window.btoa( params );
        window.location.replace(`http://localhost:8000/inconveniente/saveReport?data=${toSend}`);
    }
