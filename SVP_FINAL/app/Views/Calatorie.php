...
<body>
    ...
    <div class="content-base">
	    ...
	    <div class="final-trip-container">
            <span class="final-trip-head">Detalii calatorie</span>
            ...
            <div style="padding-left : 5%;"><?php echo $data['start_time']; ?></div>
            <span style="padding-left: 5%; font-size: large; font-weight: bold;">Durata calatorie:</span>
            <div style = "padding-left : 5%;"><?php echo $data['cost']; ?> ore</div>
	    </div>
        <div class="footer">
